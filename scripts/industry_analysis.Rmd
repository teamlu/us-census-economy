...
-   Comparing `Residential` vs `Nonresidential`
    -   market_share_5yr (29.56 vs 35.48)
    -   market_share_10yr (27.85 vs 36.32)
    -   growth_rate_3yr (6.36 vs 11.94)
    -   growth_rate_5yr (11.75 vs 9.02)
...
#     "Health Care" # https://fred.stlouisfed.org/series/PCU236224236224
#     ),
#   start = c(194.3, 235.1, 227.1, 208.0, 160.1),
#   end = c(193.3, 232.3, 224.5, 205.1, 157.9)
# )
...
table_ppi_5yr <- prepare_plot_table(
  ...
  #   percent_change_in_producer_price_index_5yr > 45, 'above_1_sd', 'below_1_sd'))
...
-   Since I already know Residential is less appealing than Non-Residential's Manufacturing sub-segment, I will forgo this part on labor market dynamics.
